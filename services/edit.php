...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE services SET heading=%s, `description`=%s, phone=%s, email=%s, reservation=%s WHERE seno=%s",
...
mysql_select_db($database_kdmcnensasala, $kdmcnensasala);
$query_service_edit = sprintf("SELECT * FROM services WHERE seno = %s", GetSQLValueString($colname_service_edit, "int"));
...
<body class="body_min">
<h2 class="page_min_head">Services</h2>
