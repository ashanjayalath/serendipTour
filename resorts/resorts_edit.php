...
//$imgName = basename( $_FILES["newsImg"]["name"]);	
	...
	$imgName = $_POST['logo_old'];
}
	
  $updateSQL = sprintf("UPDATE resorts SET name=%s, `variable`=%s, `description`=%s, country=%s, place=%s, comfort=%s, airport=%s, airplane=%s, area=%s, location=%s, logo=%s WHERE seno=%s",
...
$colname_resorts_edit = "-1";
if (isset($_GET['resort'])) {
  $colname_resorts_edit = $_GET['resort'];
}
mysql_select_db($database_kdmcnensasala, $kdmcnensasala);
$query_resorts_edit = sprintf("SELECT * FROM resorts WHERE seno = %s", GetSQLValueString($colname_resorts_edit, "int"));
$resorts_edit = mysql_query($query_resorts_edit, $kdmcnensasala) or die(mysql_error());
$row_resorts_edit = mysql_fetch_assoc($resorts_edit);
$totalRows_resorts_edit = mysql_num_rows($resorts_edit);
?>
<!DOCTYPE html>
<html>
<head>
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
  <table width="100%" border="0">
    <tr>
      ...
      <td width="250"><label>
        <input name="name" type="text" required id="name" value="<?php echo $row_resorts_edit['name']; ?>">
      </label></td>
      <td width="100" align="right">Logo:</td>
      <td width="250"><input type="file" name="logo" id="logo">
      <input name="logo_old" type="hidden" id="logo_old" value="<?php echo $row_resorts_edit['logo']; ?>"></td>
    </tr>
    <tr>
      <td width="100">Slogan:</td>
      <td colspan="3"><label>
        <input name="variable" type="text" required id="variable" value="<?php echo $row_resorts_edit['variable']; ?>">
      </label></td>
    </tr>
    <tr>
      <td width="100">Country:</td>
      <td width="250"><label>
        <input name="country" type="text" required id="country" value="<?php echo $row_resorts_edit['country']; ?>">
      </label></td>
      <td width="100" align="right">Place:</td>
      <td width="250"><label>
        <input name="place" type="text" required id="place" value="<?php echo $row_resorts_edit['place']; ?>">
      </label></td>
    </tr>
    <tr>
      <td>Comfort:</td>
      <td><label>
        <input name="comfort" type="text" required id="comfort" value="<?php echo $row_resorts_edit['comfort']; ?>">
      </label></td>
      <td align="right">Area:</td>
      <td><label>
        <input name="area" type="text" required id="area" value="<?php echo $row_resorts_edit['area']; ?>">
      </label></td>
    </tr>
    <tr>
      <td>Airport:</td>
      <td><label>
        <input name="airport" type="text" required id="airport" value="<?php echo $row_resorts_edit['airport']; ?>">
      </label></td>
      <td align="right">Airplane:</td>
      <td><label>
        <input name="airplane" type="text" required id="airplane" value="<?php echo $row_resorts_edit['airplane']; ?>">
      </label></td>
    </tr>
    <tr>
      <td>Location:</td>
    ...
    <tr>
		<td colspan="4"><textarea name="location" rows="2"required id="location" style="height:auto;"><?php echo $row_resorts_edit['location']; ?></textarea></td>
    </tr>
    <tr>
      <td>Description:</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="4"><label>
        <textarea name="description" id="description" required><?php echo $row_resorts_edit['description']; ?></textarea>
    ...
    <tr>
      ...
      <td width="250" align="right"><label>
        <input name="seno" type="hidden" id="seno" value="<?php echo $row_resorts_edit['seno']; ?>">
...
<?php
mysql_free_result($resorts_edit);
?>
