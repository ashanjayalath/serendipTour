...
//$imgName = basename( $_FILES["newsImg"]["name"]);
  ...
  $insertSQL = sprintf("INSERT INTO resorts_meeting (resort_id, heading, image, `description`, phone, email, reservation) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "resorts_business.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <table width="100%" border="0">
    <tbody>
      <tr>
        ...
        <td width="250"><input name="heading" type="text" required="required" id="heading"></td>
        <td width="100" align="right">Image:</td>
        <td width="250" align="right"><input name="image" type="file" required="required" id="image"></td>
      </tr>
      <tr>
        <td>Phone:</td>
        <td><input name="phone" type="text" required="required" id="phone"></td>
        <td align="right">e-mail:</td>
        <td align="right"><input name="email" type="text" required="required" id="email"></td>
      </tr>
      <tr>
        <td width="100">Description:</td>
        <td width="250">&nbsp;</td>
        <td width="100" align="right">Reservation:</td>
        <td width="250" align="right"><input name="reservation" type="text" required="required" id="reservation"></td>
      </tr>
      <tr>
        <td colspan="4"><textarea name="description" required="required" id="description"></textarea>
      ...
      <tr>
        ...
        <td width="250">&nbsp;</td>
        <td width="100">&nbsp;</td>
        <td width="250" align="right"><input name="resort_id" type="hidden" id="resort_id" value="<?php echo $row_resort_getinfo['seno']; ?>">          <input type="submit" name="submit" id="submit" value="Save"></td>
      </tr>
    </tbody>
  </table>
