...
//$imgName = basename( $_FILES["newsImg"]["name"]);	
  ...
  $insertSQL = sprintf("INSERT INTO resorts_spa (resort_id, heading, image, `description`) VALUES (%s, %s, %s, %s)",
  ...
  <table width="100%" border="0">
    <tbody>
      <tr>
        ...
        <td width="250"><input type="text" name="heading" id="heading"></td>
        <td width="100" align="right">Image:</td>
        <td width="250" align="right"><input type="file" name="image" id="image"></td>
      </tr>
      <tr>
