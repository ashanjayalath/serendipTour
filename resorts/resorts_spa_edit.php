...
//$imgName = basename( $_FILES["newsImg"]["name"]);	
  ...
  $updateSQL = sprintf("UPDATE resorts_spa SET resort_id=%s, heading=%s, image=%s, `description`=%s WHERE seno=%s",
...
$colname_spa_edit = "-1";
if (isset($_GET['spa'])) {
  $colname_spa_edit = $_GET['spa'];
}
mysql_select_db($database_kdmcnensasala, $kdmcnensasala);
$query_spa_edit = sprintf("SELECT * FROM resorts_spa WHERE seno = %s", GetSQLValueString($colname_spa_edit, "int"));
$spa_edit = mysql_query($query_spa_edit, $kdmcnensasala) or die(mysql_error());
$row_spa_edit = mysql_fetch_assoc($spa_edit);
$totalRows_spa_edit = mysql_num_rows($spa_edit);
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <table width="100%" border="0">
    <tbody>
      <tr>
        ...
        <td width="250"><input name="heading" type="text" id="heading" value="<?php echo $row_spa_edit['heading']; ?>"></td>
        <td width="100" align="right">Image:</td>
        <td width="250" align="right"><input type="file" name="image" id="image">
        <input name="image_old" type="hidden" id="image_old" value="<?php echo $row_spa_edit['image']; ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="4"><textarea name="description" id="description"><?php echo $row_spa_edit['description']; ?></textarea>
      ...
      <tr>
        ...
        <td width="250">&nbsp;</td>
        <td width="100">&nbsp;</td>
        <td width="250" align="right"><input name="seno" type="hidden" id="seno" value="<?php echo $row_spa_edit['seno']; ?>">
        <input name="resort_id" type="hidden" id="resort_id" value="<?php echo $row_spa_edit['resort_id']; ?>">          <input type="submit" name="submit" id="submit" value="Save"></td>
      </tr>
    </tbody>
  </table>
