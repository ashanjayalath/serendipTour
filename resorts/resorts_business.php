...
if ((isset($_GET['delete'])) && ($_GET['delete'] != "")) {
  $deleteSQL = sprintf("DELETE FROM resorts_meeting WHERE seno=%s",
  ...
  $deleteGoTo = "resorts_business.php?resort=".$_GET['resort'];
...
mysql_select_db($database_kdmcnensasala, $kdmcnensasala);
$query_spa = sprintf("SELECT * FROM resorts_meeting WHERE resort_id = %s", GetSQLValueString($colname_spa, "int"));
...
<body class="body_min">
<h2 class="page_min_head">&nbsp;</h2>
<h2 class="page_min_head">Business - <?php echo $row_resort_getinfo['name']; ?></h2>
	
<div class="topBttn">
  <a href="resorts_business_add.php?resort=<?php echo $_GET['resort']; ?>"><input type="submit" name="button" id="button" value="Add New Business"></a>
</div>
...
<form id="form1" name="form1" method="post">
  ...
  <?php do { ?>
        <tr>
          ...
          <td width="78" align="center"><a href="resorts_business_edit.php?business=<?php echo $row_spa['seno']; ?>&resort=<?php echo $row_spa['resort_id']; ?>"><img src="../support/buttons/features/edit.fw.png" width="30" height="30" alt=""/></a> <a href="resorts_business.php?delete=<?php echo $row_spa['seno']; ?>&resort=<?php echo $row_spa['resort_id']; ?>" onclick="return confirm('Are you sure to delete this?')"><img src="../support/buttons/features/delete.fw.png" width="30" height="30" alt=""/></a></td>
        </tr>
		  <?php $i = $i + 1; ?>
