...
$imgName = 	$_POST['image_old'];
  ...
  $updateSQL = sprintf("UPDATE resorts_dine SET resort_id=%s, heading=%s, description=%s, image=%s WHERE seno=%s",
  ...
  $updateGoTo = "resorts_dine.php?resort=".$_POST['resort_id'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_dine_edit = "-1";
if (isset($_GET['dine'])) {
  $colname_dine_edit = $_GET['dine'];
}
mysql_select_db($database_kdmcnensasala, $kdmcnensasala);
$query_dine_edit = sprintf("SELECT * FROM resorts_dine WHERE seno = %s", GetSQLValueString($colname_dine_edit, "int"));
$dine_edit = mysql_query($query_dine_edit, $kdmcnensasala) or die(mysql_error());
$row_dine_edit = mysql_fetch_assoc($dine_edit);
$totalRows_dine_edit = mysql_num_rows($dine_edit);
?><!DOCTYPE html>
<html>
<head>
...
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="heading" type="text" id="heading2" value="<?php echo $row_dine_edit['heading']; ?>"></td>
      <td align="right">Image:</td>
      <td><input type="file" name="image" id="image">
      <input name="image_old" type="hidden" id="image_old" value="<?php echo $row_dine_edit['image']; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <textarea name="description" id="description"><?php echo $row_dine_edit['description']; ?></textarea>
    ...
    <tr>
      ...
      <td width="250">&nbsp;</td>
      <td width="100">&nbsp;</td>
      <td width="250" align="right"><input name="seno" type="hidden" id="seno" value="<?php echo $row_dine_edit['seno']; ?>">
      <input name="resort_id" type="hidden" id="resort_id" value="<?php echo $row_dine_edit['resort_id']; ?>">        <input type="submit" name="button" id="button" value="Save"></td>
    </tr>
  </table>
