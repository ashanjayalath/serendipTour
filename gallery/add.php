...
//$imgName = basename( $_FILES["newsImg"]["name"]);
  ...
  $insertSQL = sprintf("INSERT INTO gallery (title, descr, image) VALUES (%s, %s, %s)",
...
<h2 class="page_min_head">Add Images to Gallery</h2>
<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1">
  <table width="100%" border="0">
    <tbody>
      <tr>
        <td width="100">Title:</td>
        <td width="250"><input type="text" name="title" id="title"></td>
      ...
      <tr>
        <td colspan="4"><textarea name="descr" rows="3" id="descr" style="height:auto;"></textarea></td>
      </tr>
      <tr>
        <td width="100">&nbsp;</td>
        <td width="250">&nbsp;</td>
